...
files = glob.glob("/home/jhass2/Data/1.0/TracyWidomQuad2/T*.txt")
...
if os.path.isfile('/home/jhass2/Data/1.0/TracyWidomQuad2/mean.txt') and run_again: 
    count = 0
    for f in files:
        try:
    ...
    np.savetxt("/home/jhass2/Data/1.0/TracyWidomQuad2/mean.txt", mean)
    np.savetxt("/home/jhass2/Data/1.0/TracyWidomQuad2/var.txt", var)

else: 
    mean = np.loadtxt("/home/jhass2/Data/1.0/TracyWidomQuad2/mean.txt")
    var = np.loadtxt("/home/jhass2/Data/1.0/TracyWidomQuad2/var.txt")
...
for i in range(len(vs)):
    ...
    ax.set_yscale("log")
    ax.legend()
    fig.savefig(f"./figuresQuad2/Variance{v}.png", bbox_inches='tight')
    plt.close(fig)
...
for i in range(len(vs)):
    ...
    ax.set_yscale("log")
    ax.legend()
    fig.savefig(f"./figuresQuad2/Mean{v}.png", bbox_inches='tight')
    plt.close(fig)
