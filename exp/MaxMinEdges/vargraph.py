...
ax.scatter(1/betas, nonzeros/np.log2(float(int(1e50))), c='k', label='N=1e50') # I think I originally did int(1e50) and so it approximated 1e50 with some extra change
