#!/bin/bash
c++ -O3 -c -march=native -Wall -std=gnu++11 -fPIC $(python3-config --includes) randomDistribution.cpp -I/c/modular-boost -lquadmath -o randomDistribution.o
...
c++ -O3 -c -march=native -Wall -std=gnu++11 -fPIC $(python3-config --includes) firstPassageBase.cpp -I/c/modular-boost -lquadmath -o firstPassageBase.o
...
g++ -shared -o "libDiffusion.so" libDiffusion.o diffusionCDFBase.o diffusionPDF.o diffusionPositionCDF.o diffusionTimeCDF.o firstPassageBase.o firstPassageDriver.o firstPassagePDF.o randomNumGenerator.o firstPassageEvolve.o randomDistribution.o -I/c/modular-boost -lquadmath -I"../pybind11/include" $(python3-config --includes)