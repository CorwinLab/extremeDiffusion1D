...
c++ -O3 -c -march=native -Wall -std=gnu++11 -fPIC $(python3-config --includes) firstPassagePDFBase.cpp -I/c/modular-boost -lquadmath -o firstPassagePDFBase.o
...
g++ -shared -o "libDiffusion.so" libDiffusion.o diffusionCDFBase.o diffusionPDF.o diffusionPositionCDF.o diffusionTimeCDF.o firstPassagePDFBase.o firstPassagePDF.o randomNumGenerator.o -I/c/modular-boost -lquadmath -I"../pybind11/include" $(python3-config --includes)