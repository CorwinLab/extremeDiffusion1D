...
def calculateMeanVarHelper(
    files, skiprows=1, delimiter=",", verbose=False, maxTime=None
):
    """
    ...
    def add_directory(self, directory, dir_type, var_file="variables.json"):
        ...
        with open(vars_file, "r") as file:
            try:
                ...
                print(
                    f"Exception caught in dir {directory} trying to read variables.json file. Trying to load scalars.json file"
                )
