...
ax.plot(1/max_df['Distance'] / logN, max_df['Variance'] * max_df['Distance']**4, label=r'$\mathrm{Var}(\tau_{\mathrm{Min}})$', c=max_color, alpha=alpha)
ax.plot(1/cdf_df['Distance'] / logN, cdf_df['Sampling Variance'] * cdf_df['Distance']**4, label=r'$\mathrm{Var}(\tau_{\mathrm{Sam}})$', c=gumbel_color, alpha=alpha)
ax.plot(1/cdf_df['Distance'] / logN, cdf_df['Env Variance']*cdf_df['Distance']**4, label=r'$\mathrm{Var}(\tau_{\mathrm{Env}})$', c=quantile_color, alpha=alpha)
...
ax.plot(1/cdf_df['Distance'] / logN, (env_theory + sam_theory), ls='--', c=max_color)
