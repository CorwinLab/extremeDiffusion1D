...
ax.annotate("", xy=start_coord, xytext=end_coord,
        arrowprops=dict(shrink=0., facecolor='gray', edgecolor='white', width=50, headwidth=80, headlength=40, alpha=0.3), zorder=0)
ax.annotate(r"$\beta=\infty$", xy=(12.5, 0.4), c=colors[-1], rotation=90-abs(theta), rotation_mode='anchor', fontsize=fontsize)
ax.annotate(r"$\beta=0$", xy=(1.5, 2*10**3), c=colors[0], rotation=90-abs(theta), rotation_mode='anchor', fontsize=fontsize)
