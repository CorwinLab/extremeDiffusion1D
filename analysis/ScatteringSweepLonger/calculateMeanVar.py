...
for b in betas:
    if float(b) not in [0.1, 0.01, 1, 10, 100]:
        continue
...
# Calculate Mean and Variance for Delta Distribution
dir = '/home/jacob/Desktop/talapasMount/JacobData/ScatteringDeltaDist'
...
# Calculate Mean and Variance for N sweep directory
