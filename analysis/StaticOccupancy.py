...
d = DiffusionPDF(N, 1, numSteps, ProbDistFlag=False, staticEnvironment=True)
...
fig.savefig("StaticOccupation.pdf", bbox_inches='tight')

print(d.getTransitionProbabilities())