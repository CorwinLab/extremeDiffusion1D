...
dir = '/home/jacob/Desktop/talapasMount/JacobData/RandomDiffusion/'
files = glob.glob(os.path.join(dir, 'P*.txt'))
tMax = 49999
...
mean = pd.DataFrame(mean, columns=['Time', 'Position', 'Probability'])
var = pd.DataFrame(var, columns=['Time', 'Position', 'Probability'])
