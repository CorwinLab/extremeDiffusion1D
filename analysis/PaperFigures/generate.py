...
db = Database()
db.add_directory(
    "/home/jacob/Desktop/corwinLabMount/CleanData/MaxBetaSweep2/1/", dir_type="Max"
)
db.add_directory(
    "/home/jacob/Desktop/corwinLabMount/CleanData/MaxBetaSweep2/5/", dir_type="Max"
)
db.add_directory(
    "/home/jacob/Desktop/corwinLabMount/CleanData/SweepVariance/", dir_type="Gumbel"
)
db.add_directory(
    "/home/jacob/Desktop/corwinLabMount/CleanData/MaxPart100/", dir_type="Max"
)
db.add_directory(
    "/home/jacob/Desktop/corwinLabMount/CleanData/MaxPart300/", dir_type="Max"
)
db.add_directory(
    "/home/jacob/Desktop/corwinLabMount/CleanData/MaxPartSmall/2/", dir_type="Max"
)
db.add_directory(
    "/home/jacob/Desktop/corwinLabMount/CleanData/MaxPartSmall/6/", dir_type="Max"
)
db.add_directory(
    "/home/jacob/Desktop/corwinLabMount/CleanData/MaxPartSmall/20/", dir_type="Max"
)
db.add_directory(
    "/home/jacob/Desktop/corwinLabMount/CleanData/CDFSmallBeta1/", dir_type="Gumbel"
)
...
for i, N in enumerate(quantiles):
    ...
    ax.plot(
        (cdf_df["time"]) / logN, cdf_df["Mean Quantile"] - 2, alpha=0.5, c=colors[i]
    )
...
for i, quantile in enumerate(quantiles):
    ...
    ax.plot(
        max_df["time"] / logN,
        (var_theory) / logN ** (2 / 3)
        + np.pi ** 2 / 12 * max_df["time"] / logN / logN ** (2 / 3),
        "--",
        c=colors[i],
    )
    ax.plot(
        max_df["time"] / logN,
        max_df["Var Max"] / logN ** (2 / 3),
        label=quantile,
        c=colors[i],
        alpha=0.5,
    )
...
ax.annotate(
    r"$N=10^{2}$",
    xy=(start_coord[0] - 90, start_coord[1] - 17),
    c=colors[0],
...
alpha = 0.7
theory_var = theory.quantileVar(
    N, max_df["time"].values, crossover=logN ** (3 / 2), width=logN ** (4 / 3)
)
ax.plot(
    max_df["time"] / logN,
    max_df["Var Max"],
...
ax.plot(
    max_df["time"] / logN,
    theory_var + einstein_var(max_df["time"].values, N),
    ls="--",
    c="r",
)
