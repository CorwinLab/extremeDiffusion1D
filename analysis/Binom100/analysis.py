...
dir_smaller = '/home/jacob/Desktop/talapasMount/JacobData/Binom100/0.01'
dir = '/home/jacob/Desktop/talapasMount/JacobData/Binom100/'
...
mean_smaller = pd.read_csv('/home/jacob/Desktop/talapasMount/JacobData/Binom100/0.01/Mean.txt')
var_smaller = pd.read_csv('/home/jacob/Desktop/talapasMount/JacobData/Binom100/0.01/Var.txt')
...
ax.plot(mean_smaller['Time'] / np.log(N), -mean_smaller['Probability'])
...
ax.plot(var_smaller['Time'] / np.log(N), var_smaller['Probability'])
