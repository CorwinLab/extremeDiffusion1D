...
files = glob.glob('/home/jacob/Desktop/talapasMount/JacobData/Parallel500Systems/F*.txt')
...
ax.plot(distances / logN, var_mean_envs + mean_var_envs, '--', label='Orange + blue')
ax.plot(distances / logN, var_total - mean_var_envs, 'm--', label='minus')
ax.legend()
ax.set_xlim([0.3, 100])
...
ax.plot(distances / logN, (var_total - mean_var_envs) - var_mean_envs)
