...
dir = '/home/jacob/Desktop/corwinLabMount/CleanData/Continuous/M*.txt'
files = glob.glob(dir)
data_sum = None
...
ax.plot(xvals, 40*xvals ** (1/2), ls='--', label=r'$\sqrt{t}$', c='k')
ax.plot(time, mean, c='b')
ax.set_xlim([10, 10**4])
ax.set_xlabel("Time")
ax.set_xscale("log")
ax.set_yscale("log")
...
fig, ax = plt.subplots()
ax.plot(xvals, xvals, ls='--', c='k', label=r'$t$')
ax.plot(time, var, c='b')
ax.set_xlim([10, 10**4])
ax.set_xscale("log")
ax.set_yscale("log")
ax.set_xlabel("Time")
