...
gamma = '1'
dir = f'/home/jacob/Desktop/talapasMount/JacobData/RWRESpaceTimeDampedFullyCorrect/{gamma}/'
vs = os.listdir(dir)
...
for i, v in enumerate(vs):
	...
	ax.plot(var[1:, 0], var[1:, 1], c=colors[i], label='Scattering Model', ls='--', alpha=0.5)
	ax.plot(var[1:, 0], rwre_var[:, 1], c = colors[i])
